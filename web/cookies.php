...
<body>
    ...
    <Section>
        ...
        <div class="row">
            <div class="col-4">
                <img src="chip.jpg" class="img-fluid img-thumbnail mx-auto d-block" alt="Computer Chip">
            </div>
            <div class="col-4">
                <div class="jumbotron">
                    <h1>Order Now<h1><br>
            ...
            <div class="col-4">
                <img src="cookies.jpg" class="img-fluid img-thumbnail mx-auto d-block" alt="Cookies">
            </div>
        </div>
    </Section>
</body>
