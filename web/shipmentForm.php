...
<body>
    ...
    <form action="shipmentInsert.php" method="POST">
        <label for="pickUpState">Pick Up State</label>
        <select id="pickUpState" name="pickUpState"><option value="---">---</option>
        ...
        <select id="DropOffState" name="DropOffState"><option value="---">---</option>
        <option value="Alabama">Alabama</option>
        <option value="Alaska">Alaska</option>
        <option value="Arizona">Arizona</option>
        <option value="Arkansas">Arkansas</option>
