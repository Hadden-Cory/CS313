...
<body>
    ...
    <Section>
        <div class="jumbotron">
            ...
            <img src="/week03ponder/seeds.jpg" class="img-fluid thumbnail float-left mx-auto d-block" alt="Seeds">
            <img src="/week03ponder/gummy.jpg" class="img-fluid thumbnail float-right mx-auto d-block" alt="Gummy Bears">
        <div class="jumbotron">
        </div>
    </Section>
</body>
